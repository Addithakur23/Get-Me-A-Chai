...
const Account_Hamburger = () => {
  return (
    //     right: 84px;
    // width: 26%;
       <div className="dashboardOptionBox flex max-sm:top-[102px] flex-col w-[12%] absolute top-13.75 right-0.75 max-sm:w-[32%] max-sm:right-[43px] max-md:w-[25%] max-md:right-[35px] max-lg:w-[22%] max-lg:right-[25px]">
